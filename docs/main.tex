...
\begin{itemize}
  ...
  \item bazy grafowe - do pokazania relacji miedzy obiektami
  \item bazy kolumnowe - do przechowywania dużej ilości danych 
\end{itemize}


Często właśnie łączy się kilka tych rozwiązań, aby mieć więcej możliwości skalowania aplikacji, dlatego serwisy takie jak twiiter korzystają z architektury mikroserwisów z uwagi na spory ruch, dodatkowo każda baza jest odpowiednio zopytmalizowana pod jakimś kontem (wady - zalety).
