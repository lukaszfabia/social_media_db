...
Oczywiście najlepszym rozwiązaniem byłoby wydzielenie tabel do odpowiednich baz danych. To znaczy niektóre tabele przechowywać w bazie relacyjnej a niektóre w nie relacyjnej a jeszcze inne w np. Grafowej. 
...
Wysoka wydajność odczytu i zapisu                                & Większe zużycie pamięci (denormalizacja niektórych tabel) \\ \hline
Obsługa ACID                                                     & Duży ruch = duże koszty                                   \\ \hline
Duży wybór jeśli chodzi o zapytania agregacyjne (match, project) &                                                           \\ \hline
