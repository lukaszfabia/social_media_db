...
Poniżej odpowiedniki komend SQL w MongoDB (NoSQL).
...
\href{https://danieljeziorski.pl/pojecia-acid-oraz-base-w-kontekscie-baz-danych-nosql/}{Artykuł, którym się posiłkowaliśmy.}
