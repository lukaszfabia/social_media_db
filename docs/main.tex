...
Diagram ERD \ref{fig:new_erd} został zaktualizowany - odzwierciedla schemat relacji w bazie oraz jest czytelniejszy względem poprzedniego. Zdecydowaliśmy się nie umieszać szczątkowych artybutów dla encji, ponieważ wprowadziło by to zbędne zamieszanie i wpłyneło by to na czytelność. 

Zmieniono: 

\begin{itemize}
  \item Dodano \texttt{User Privilege}
  \item Rozbito \texttt{Location}, na pomniejsze encje
  ...
  \item No i usuneliśmy encje \texttt{Process}, dodaną losowo. 
\end{itemize}


\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.95\textwidth]{docs/images/erd_8_1.png} 
  \end{center}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.95\textwidth]{docs/images/DiagramBazyDanych_8_2.png}
  \end{center}
