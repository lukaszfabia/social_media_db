...
\begin{itemize}
    ...
    \item Średnia liczba reakcji na post w ostatnim miesiącu
    \item Wydarzenia w danym mieście (np. Saint Petersburg)
    \item Wydarzenia, w których wezmą udział znajomi autora
    \item Tagi stron, posortowane po liczbie polubień i wyświetleń
    \item Ludzie ze wspólnymi znajomymi
...
\begin{figure}[H]
    ...
    \caption{Wynik kwerendy wyszukującej użytkowników z dużą liczbą wspólnych znajomych}
    \label{fig:sql_1}
\end{figure}
