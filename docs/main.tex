...
Usuwanie wierszy w bazie danych powinno zostać zachowane do minimum (powinno się ustawiać flagę DeletedAt). Jednak gdy usunie się wiersz, który jest powiązany z innym, to wtedy powinny zostać usunięte również te powiązane (usuwanie kaskadowe).
...
\begin{itemize}
    ...
    \item Nie można wysłać zaproszenia do samego siebie.
\end{itemize}
