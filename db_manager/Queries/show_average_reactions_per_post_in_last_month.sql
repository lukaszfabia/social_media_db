...
FROM
    (
        SELECT
            ...
            SUM(
                CASE
                    WHEN r.reaction = 'like' THEN 1
                    ELSE 0
                END
            ) AS likeCount,
            SUM(
                CASE
                    WHEN r.reaction = 'love' THEN 1
                    ELSE 0
                END
            ) AS loveCount,
            SUM(
                CASE
                    WHEN r.reaction = 'haha' THEN 1
                    ELSE 0
                END
            ) AS hahaCount,
            SUM(
                CASE
                    WHEN r.reaction = 'wow' THEN 1
                    ELSE 0
                END
            ) AS wowCount,
            SUM(
                CASE
                    WHEN r.reaction = 'sad' THEN 1
                    ELSE 0
                END
            ) AS sadCount,
            SUM(
                CASE
                    WHEN r.reaction = 'angry' THEN 1
                    ELSE 0
                END
            ) AS angryCount
        FROM
