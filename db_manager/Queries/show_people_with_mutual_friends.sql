SELECT
    friendsOfFriends.user_author_id,
    u.first_name,
    u.second_name,
    COUNT(*) AS mutualFriendsCount
FROM
    user_friends friendsOfUser
...
WHERE
    friendsOfUser.user_author_id = 1
    AND friendsOfFriends.user_author_id != 1
GROUP BY
    friendsOfFriends.user_author_id,
    u.first_name,
    u.second_name
